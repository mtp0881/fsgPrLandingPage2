...
const translations: Record<Language, Record<string, string>> = {
  ja: {
    ...
    'hero.title': 'FSG事業部',
    'hero.subtitle': '金融公共Salesforce 3つの専門分野で日本企業のDXを支援',
    'hero.cta': '詳細を見る',
    ...
    'services.org_desc': 'FSG事業部の組織体制を紹介',
  ...
  en: {
    ...
    'hero.title': 'Financial Services Group',
    'hero.subtitle': "Supporting Japanese enterprises' DX with Finance, Public, and Salesforce expertise",
    'hero.cta': 'Learn More',
    ...
    'services.org_desc': 'Learn about FSG organization structure',
    ...
    'org.title': 'FSG Organization Chart',
