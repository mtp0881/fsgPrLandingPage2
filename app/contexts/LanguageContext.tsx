...
const translations: Record<Language, Record<string, string>> = {
  ja: {
    ...
    'hero.subtitle': '金融・公共の専門分野とSalesforce戦略プログラムで日本企業のDXを支援',
    'hero.cta': '詳細を見る',
  ...
  en: {
    ...
    'hero.subtitle': "Supporting Japanese enterprises' DX through Finance & Public sector specialization and Salesforce strategic program",
    'hero.cta': 'Learn More',
